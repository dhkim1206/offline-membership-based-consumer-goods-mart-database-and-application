...
{
    public partial class 사용자메인_진짜 : Form
    {
        //로그인 유저 아이디값 받아오기
        ...
        private void 사용자메인_진짜_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (dgr.Cells[7].Value.ToString() == "리뷰작성완료")
            {
                MessageBox.Show("리뷰를 작성한 상품은 환불을 할 수 없습니다.");
            }
